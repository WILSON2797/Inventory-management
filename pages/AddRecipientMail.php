    ...
    <div class="container-fluid px-4 mt-4">
        <div class="card mb-4">
            <div class="card-header">
                Inbound Data Table
                <div class="float-end">
                    <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#recipientsModal">
                        <i data-feather="plus" style="width: 14px; height: 14px;"></i> Add New Mail Recipient
                    </button>
                    
                    <button class="btn btn-success btn-sm" id="exportExcelmail">
            ...
            <div class="card-body" style="overflow-x: auto;">
                <div class="table-responsive" style="overflow-x: auto;">
                    <table class="table table-striped table-hover table-bordered compact-action" id="tabelrecipients"
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="recipientsModalLabel">Add New Recipient</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="recipientsForm" action="php/submit_recipient.php" method="POST">
                    <div class="row mb-3">
                        <div class="col-md-11">
