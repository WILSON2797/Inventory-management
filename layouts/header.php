...
<nav class="topnav navbar navbar-expand shadow justify-content-between justify-content-sm-start navbar-light bg-white" id="sidenavAccordion">
    ...
    <ul class="navbar-nav align-items-center ms-auto">
        ...
        <div class="d-none d-lg-flex align-items-center ms-3 me-auto">
        <div class="badge-container">
            <span class="badge bg-<?php echo $hasContext ? 'primary' : 'secondary'; ?> me-2 d-inline-flex align-items-center">
                <i data-feather="database" class="me-1 icon-center"></i>
                WH: <?php echo htmlspecialchars($currentWH, ENT_QUOTES, 'UTF-8'); ?>
            </span>
            <span class="badge bg-<?php echo $hasContext ? 'success' : 'secondary'; ?> d-inline-flex align-items-center">
                <i data-feather="folder" class="me-1 icon-center"></i>
                Project: <?php echo htmlspecialchars($currentProject, ENT_QUOTES, 'UTF-8'); ?>
            </span>
        </div>
    </div>
        
        <li class="nav-item dropdown no-caret d-none d-sm-block me-3 dropdown-notifications" style="position: relative;">
            ...
            <!-- Badge Notifikasi - Outside link tag -->
            <span class="badge badge-notification" 
                  id="pendingOrderBadge" 
                  style="display: none;">0</span>
        </li>
        <!-- Messages Dropdown dengan Notifikasi Pending Orders End -->
